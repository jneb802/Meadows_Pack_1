...
namespace Meadows_Pack_1
{
    ...
    public class Meadows_Pack_1Plugin : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            MWL_Ruins1_CreatureYaml_Config = config("1 - MWL_Ruins1", "Use Custom Creature YAML file", Toggle.Off,
            ...
            MWL_Ruins1_LootYaml_Config = config("1 - MWL_Ruins1", "Use Custom Loot YAML file", Toggle.Off,
            ...
            MWL_Ruins2_CreatureList_Config = config("2 - MWL_Ruins2", "Name of Creature List", "MeadowsCreatures1",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_Ruins2_LootYaml_Config = config("2 - MWL_Ruins2", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            MWL_Ruins2_LootList_Config = config("2 - MWL_Ruins2", "Name of Loot List", "MeadowsLoot2",
                "The name of the loot list to use from warpalicious.More_World_Locations_LootLists.yml file");
            
            MWL_Ruins3_Quantity_Config = config("3 - MWL_Ruins3", "MWL_Ruins3", 25,
                "Amount of this location the game will attempt to place during world generation");
            MWL_Ruins3_CreatureYaml_Config = config("3 - MWL_Ruins3", "Use Custom Creature YAML file", Toggle.Off,
                "When Off, location will spawn default creatures. When On, location will select creatures from list in the warpalicious.More_World_Locations_CreatureLists.yml file in BepinEx config folder");
            MWL_Ruins3_CreatureList_Config = config("3 - MWL_Ruins3", "Name of Creature List", "MeadowsCreatures1",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_Ruins3_LootYaml_Config = config("3 - MWL_Ruins3", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            MWL_Ruins3_LootList_Config = config("3 - MWL_Ruins3", "Name of Loot List", "MeadowsLoot1",
                "The name of the loot list to use from warpalicious.More_World_Locations_LootLists.yml file");
            
            
            MWL_Ruins6_Quantity_Config = config("4 - MWL_Ruins6", "MWL_Ruins6", 5,
                "Amount of this location the game will attempt to place during world generation");
            MWL_Ruins6_CreatureYaml_Config = config("4 - MWL_Ruins6", "Use Custom Creature YAML file", Toggle.Off,
                "When Off, location will spawn default creatures. When On, location will select creatures from list in the warpalicious.More_World_Locations_CreatureLists.yml file in BepinEx config folder");
            MWL_Ruins6_CreatureList_Config = config("4 - MWL_Ruins6", "Name of Creature List", "MeadowsCreatures2",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_Ruins6_LootYaml_Config = config("4 - MWL_Ruins6", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            MWL_Ruins6_LootList_Config = config("4 - MWL_Ruins6", "Name of Loot List", "MeadowsLoot3",
                "The name of the loot list to use from warpalicious.More_World_Locations_LootLists.yml file");

            MWL_Ruins7_Quantity_Config = config("5 - MWL_Ruins7", "MWL_Ruins7", 2,
                "Amount of this location the game will attempt to place during world generation");
            MWL_Ruins7_CreatureYaml_Config = config("5 - MWL_Ruins7", "Use Custom Creature YAML file", Toggle.Off,
                "When Off, location will spawn default creatures. When On, location will select creatures from list in the warpalicious.More_World_Locations_CreatureLists.yml file in BepinEx config folder");
            MWL_Ruins7_CreatureList_Config = config("5 - MWL_Ruins7", "Name of Creature List", "MeadowsCreatures2",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_Ruins7_LootYaml_Config = config("5 - MWL_Ruins7", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            MWL_Ruins7_LootList_Config = config("5 - MWL_Ruins7", "Name of Loot List", "MeadowsLoot1",
                "The name of the loot list to use from warpalicious.More_World_Locations_LootLists.yml file");
            
            MWL_Ruins8_Quantity_Config = config("6 - MWL_Ruins8", "MWL_Ruins8", 5,
                "Amount of this location the game will attempt to place during world generation");
            MWL_Ruins8_CreatureYaml_Config = config("6 - MWL_Ruins8", "Use Custom Creature YAML file", Toggle.Off,
                "When Off, location will spawn default creatures. When On, location will select creatures from list in the warpalicious.More_World_Locations_CreatureLists.yml file in BepinEx config folder");
            MWL_Ruins8_CreatureList_Config = config("6 - MWL_Ruins8", "Name of Creature List", "MeadowsCreatures2",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_Ruins8_LootYaml_Config = config("6 - MWL_Ruins8", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            ...
            MWL_RuinsArena1_CreatureList_Config = config("7 - MWL_RuinsArena1", "Name of Creature List", "MeadowsCreatures1",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_RuinsArena1_LootYaml_Config = config("7 - MWL_RuinsArena1", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            MWL_RuinsArena1_LootList_Config = config("7 - MWL_RuinsArena1", "Name of Loot List", "MeadowsLoot3",
                "The name of the loot list to use from warpalicious.More_World_Locations_LootLists.yml file");
            
            MWL_RuinsArena3_Quantity_Config = config("8 - MWL_RuinsArena3", "MWL_RuinsArena3", 25,
                "Amount of this location the game will attempt to place during world generation");
            MWL_RuinsArena3_CreatureYaml_Config = config("8 - MWL_RuinsArena3", "Use Custom Creature YAML file", Toggle.Off,
                "When Off, location will spawn default creatures. When On, location will select creatures from list in the warpalicious.More_World_Locations_CreatureLists.yml file in BepinEx config folder");
            MWL_RuinsArena3_CreatureList_Config = config("8 - MWL_RuinsArena3", "Name of Creature List", "MeadowsCreatures1",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_RuinsArena3_LootYaml_Config = config("8 - MWL_RuinsArena3", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            MWL_RuinsArena3_LootList_Config = config("8 - MWL_RuinsArena3", "Name of Loot List", "MeadowsLoot2",
                "The name of the loot list to use from warpalicious.More_World_Locations_LootLists.yml file");

            MWL_RuinsChurch1_Quantity_Config = config("9 - MWL_RuinsChurch1", "MWL_RuinsChurch1", 25,
                "Amount of this location the game will attempt to place during world generation");
            MWL_RuinsChurch1_CreatureYaml_Config = config("9 - MWL_RuinsChurch1", "Use Custom Creature YAML file", Toggle.Off,
                "When Off, location will spawn default creatures. When On, location will select creatures from list in the warpalicious.More_World_Locations_CreatureLists.yml file in BepinEx config folder");
            MWL_RuinsChurch1_CreatureList_Config = config("9 - MWL_RuinsChurch1", "Name of Creature List", "MeadowsCreatures1",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_RuinsChurch1_LootYaml_Config = config("9 - MWL_RuinsChurch1", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
            MWL_RuinsChurch1_LootList_Config = config("9 - MWL_RuinsChurch1", "Name of Loot List", "MeadowsLoot2",
                "The name of the loot list to use from warpalicious.More_World_Locations_LootLists.yml file");
            
            MWL_RuinsWell1_Quantity_Config = config("10 - MWL_RuinsWell1", "MWL_RuinsWell1", 5,
                "Amount of this location the game will attempt to place during world generation");
            MWL_RuinsWell1_CreatureYaml_Config = config("10 - MWL_RuinsWell1", "Use Custom Creature YAML file", Toggle.Off,
                "When Off, location will spawn default creatures. When On, location will select creatures from list in the warpalicious.More_World_Locations_CreatureLists.yml file in BepinEx config folder");
            MWL_RuinsWell1_CreatureList_Config = config("10 - MWL_RuinsWell1", "Name of Creature List", "MeadowsCreatures1",
                "The name of the creature list to use from warpalicious.More_World_Locations_CreatureLists.yml file");
            MWL_RuinsWell1_LootYaml_Config = config("10 - MWL_RuinsWell1", "Use Custom Loot YAML file", Toggle.Off,
                "When Off, location will use default loot. When On, location will select loot from list in the warpalicious.More_World_Locations_LootLists.yml file in BepinEx config folder");
        ...
        public static ConfigEntry<Toggle> MWL_Ruins1_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_Ruins2_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_Ruins2_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_Ruins2_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_Ruins3_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_Ruins3_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_Ruins3_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_Ruins6_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_Ruins6_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_Ruins6_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_Ruins7_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_Ruins7_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_Ruins7_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_Ruins8_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_Ruins8_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_Ruins8_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_RuinsArena1_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_RuinsArena1_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_RuinsArena1_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_RuinsArena3_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_RuinsArena3_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_RuinsArena3_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_RuinsChurch1_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_RuinsChurch1_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_RuinsChurch1_LootYaml_Config = null!;
        ...
        public static ConfigEntry<Toggle> MWL_RuinsWell1_CreatureYaml_Config = null!;
        public static ConfigEntry<string> MWL_RuinsWell1_CreatureList_Config = null!;
        public static ConfigEntry<Toggle> MWL_RuinsWell1_LootYaml_Config = null!;
